        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePatha = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WrittingMotivation = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_Author_AuthorId1",
                        column: x => x.AuthorId1,
                        principalTable: "Author",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Articles_SubCategories_SubCategoryId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_SubCategoryId1",
                table: "Articles",
                column: "SubCategoryId1");

            migrationBuilder.CreateIndex(
                name: "IX_Author_UserId1",
                table: "Author",
                column: "UserId1");
